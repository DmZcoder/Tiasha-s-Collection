...
const dresses = [
  { image: '/assets/dress-01.jpg', label: 'Featured Look' },
  { image: '/assets/dress-04.jpg', label: 'Signature Style' },
  { image: '/assets/dress-05.jpg', label: 'Elegant Edit' },
  { image: '/assets/dress-06.jpg', label: 'Soft Statement' },
  { image: '/assets/dress-07.jpg', label: 'The Collection' },
]

const whatsapp = '01711-772882'
const whatsappLink = `https://wa.me/8801711772882`
          ...
          <div className="editorial-stories">
            ...
            <article className="editorial-row row-right">
              ...
              <div className="editorial-image">
                <img src="/assets/dress-01.jpg" alt="Tiasha's Collection featured dress" />
              </div>
            </article>

            <article className="editorial-row row-left">
              <div className="editorial-image">
                <img src="/assets/dress-04.jpg" alt="Tiasha's Collection signature dress" />
              </div>
              <div className="editorial-text">
            ...
            <article className="editorial-row row-right">
              ...
              <div className="editorial-image">
                <img src="/assets/dress-05.jpg" alt="Tiasha's Collection elegant dress" />
              </div>
            </article>

            <article className="editorial-row row-left">
              <div className="editorial-image">
                <img src="/assets/dress-06.jpg" alt="Tiasha's Collection soft statement dress" />
              </div>
              <div className="editorial-text">
            ...
            <article className="editorial-row row-right">
              ...
              <div className="editorial-image">
                <img src="/assets/dress-07.jpg" alt="Tiasha's Collection final editorial look" />
              </div>
            </article>
